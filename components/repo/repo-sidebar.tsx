...
const RepoSidebar = ({
  ...
  return (
    <>
	  ...
	  <button id="publishChangesBtn" data-build-hook={config?.object?.build_hook} onClick={() => window?.oodelalli?.publishChanges && window.oodelalli.publishChanges(this)}>Publish</button>
